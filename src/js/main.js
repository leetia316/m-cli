...
/**
 * Created by shanq@qq.com on 2017/3/16.
 */
!function () {
    var global = {
        is: function () { /* 环境 */
        ...
        cookie: function (e, t, r) {
            ...
            if ("undefined" === typeof t) {
                if (t = null, document.cookie && "" !== document.cookie)for (r = document.cookie.split(";"), o = 0; o < r.length; o++)if (n = $.trim(r[o]), n.substring(0, e.length + 1) === e + "=") {
            ...
            r = r || {};
            null === t && (t = "", r.expires = -1);
            n = "";
            r.expires && ("number" === typeof r.expires || r.expires.toUTCString) && ("number" === typeof r.expires ? (o = new Date, o.setTime(o.getTime() + 864e5 * r.expires)) : o = r.expires, n = "; expires=" + o.toUTCString());
            o = r.path ? "; path=" + r.path : "";
            i = r.domain ? "; domain=" + r.domain : "";
            r = r.secure ? "; secure" : "";
            document.cookie = [e, "=", encodeURIComponent(t), n, o, i, r].join("")
        ...
        tpl: function (t, e, n) {
            ...
            r.pt = r.prototype, window.errors = 0, r.pt.parse = function (t, e) {
                ...
                var n;
                return t ? (n = this.cache ? this.cache(t, i.escape) : this.parse(this.tpl, t), console.log(), e ? void e(n) : n) : i.error("no data")
            };
            var a = function (t) {
    ...
    global.upload = function (options, callback) {
        /**
         * options.elem :this
         * options.quality 压缩比率 0-1
         * options.progress:function(进度)
         * callback(o)
         *  o.status : 是否执行成功
         *  o.msg : 执行提示
         *  o.src : url链接
         */
        var input = options.elem, quality = options.quality || 0.92;
        ...
        var go = function () {
            ...
            if (!/image\/\w+/.test(file.type)) {
                callback({status: 0, msg: "上传的文件格式错误"});
                return false;
            } else {
        ...
        var canvas = function (src) {
            ...
            img.onload = function () {
                ...
                callback({status: 1, src: canvas.toDataURL('image/jpeg', quality), msg: "上传成功"});
            };
            img.onerror = function () {
                callback({status: 0, msg: "无法读取上传的图片文件"});
            }
        };
        if (typeof FileReader === 'undefined') {
            input.setAttribute('disabled', 'disabled');
            input.className += 'is-disabled';
            callback({status: 0, msg: "不支持图片上传"});
        } else {
            input.addEventListener('change', go, false);
        }
    };
    ...
    function fastClick() {
        ...
        $.fn.on = function () {
            if (/click/.test(arguments[0]) && typeof arguments[1] === 'function' && supportTouch) { // Zepto.js扩展支持touch的当前元素的click事件
